        ...
        <div className="event-item bg-gray mb-4 brd-5">
          <div className="row p-0 m-0">
            <div className="col-sm-12 event_cover">
              <img src={event.cover_photo.url} alt="" className="w-100 h-100" />
            ...
            <div className="item-data pt-4 mx-auto">
              ...
              <i className="fas fa-walking f-48"></i>
              <p className="fw-b">{event.users}</p>
            </div>
            <div className="item-data pt-4 mx-auto">
              <p className="f-12 mb-1 m-0">Feedbacks</p>
              <i className="fa fa-users f-48" aria-hidden="true"></i>
              <p className="fw-b">
            ...
            <div className="item-data pt-4 mx-auto">
              ...
              <i className="fas fa-chalkboard-teacher f-48"></i>
